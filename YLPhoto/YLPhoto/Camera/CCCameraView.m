...
//    self.previewView = [[CCVideoPreview alloc]initWithFrame:CGRectMake(0, 64, self.width, self.height-64-100)];
    self.previewView = [[CCVideoPreview alloc] initWithFrame:self.bounds];
...
//    [self.bottomView addSubview:typeButton];
    ...
    dismissBtn.frame = CGRectMake(15, 20, 30, 30);
...
//    [switchCameraButton setTitle:@"转换摄像头" forState:UIControlStateNormal];
    [switchCameraButton setBackgroundImage:[UIImage imageNamed:@"take_turn_camera"] forState:UIControlStateNormal];
